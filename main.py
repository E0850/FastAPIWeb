...
# Normalize potential HTML entity in query string (Render envs often paste '&amp;')
...
async def okta_callback(code: Optional[str] = None, state: Optional[str] = None):
    ...
    # --- Confidential client: authenticate with client_secret_basic (recommended by Okta) ---
    # Build the body WITHOUT client_secret
    data = {
