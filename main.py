...
# === Ported routers from local main.py (Customers, Invoices, Agreements, Users) ===
...
# Apply per-endpoint scope enforcement (Customers, Invoices, Agreements, Users)
from fastapi import Depends as _Depends

def _set_dep(router, path: str, dep):
...
# Customers
_set_dep(customers_router, '/CreateCustomers', WRITE_DEPS['customers'])
_set_dep(customers_router, '/UpdateCustomers/{Customer_Number}', WRITE_DEPS['customers'])
_set_dep(customers_router, '/DeleteCustomers/{Customer_Number}', WRITE_DEPS['customers'])
# Invoices
_set_dep(invoices_router, '/CreateInvoices', WRITE_DEPS['invoices'])
_set_dep(invoices_router, '/UpdateInvoices/{Invoice_Number}', WRITE_DEPS['invoices'])
_set_dep(invoices_router, '/DeleteInvoices/{Invoice_Number}', WRITE_DEPS['invoices'])
# Agreements
_set_dep(agreements_router, '/CreateAgreements', WRITE_DEPS['agreements'])
_set_dep(agreements_router, '/UpdateAgreements/{Agreement_number}', WRITE_DEPS['agreements'])
_set_dep(agreements_router, '/DeleteAgreement/{Agreement_number}', WRITE_DEPS['agreements'])
# Users (manage scope)
_set_dep(users_router, '/CreateUsers', Depends(scopes('users:manage')))
_set_dep(users_router, '/UpdateUsers/{email}', Depends(scopes('users:manage')))
_set_dep(users_router, '/UpdatePassword/{email}', Depends(scopes('users:manage')))
_set_dep(users_router, '/DeleteUsers/{email}', Depends(scopes('users:manage')))
_set_dep(users_router, '/RevokeTokens/{email}', Depends(scopes('users:manage')))
